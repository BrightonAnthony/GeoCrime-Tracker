...
Users (police or public) enter crime-related information via a web portal.
Data goes through an approval process by the police.
The system uses both the approved current data and past crime data to generate real-time crime alerts and identify hotspots in specific areas.
...
Criminal Profile Visualization:
